 ...
 * @author Alex Ruiz
 */
public class ByteArrayAssert_isNotNull_Test implements NullableAssert_isNotNull_TestCase {
  ...
  public void should_have_leaf_assertion_class_as_return_type() {
    ByteArrayAssert initialInstance = new ByteArrayAssert((byte) 1);
    @SuppressWarnings("unused")
    ByteArrayAssert returnValue = initialInstance.isNotNull();
  }
}
