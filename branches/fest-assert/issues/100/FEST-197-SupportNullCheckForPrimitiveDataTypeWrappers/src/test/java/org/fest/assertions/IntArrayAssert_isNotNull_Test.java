 ...
 * @author Alex Ruiz
 */
public class IntArrayAssert_isNotNull_Test implements NullableAssert_isNotNull_TestCase {
  ...
  public void should_have_leaf_assertion_class_as_return_type() {
    IntArrayAssert initialInstance = new IntArrayAssert(1, 2, 3);
    @SuppressWarnings("unused")
    IntArrayAssert returnValue = initialInstance.isNotNull();
  }
}
