 ...
 * @author Alex Ruiz
 */
public class ShortArrayAssert_isNotNull_Test implements NullableAssert_isNotNull_TestCase {
  ...
  public void should_have_leaf_assertion_class_as_return_type() {
    ShortArrayAssert initialInstance = new ShortArrayAssert((short) 1);
    @SuppressWarnings("unused")
    ShortArrayAssert returnValue = initialInstance.isNotNull();
  }
}
