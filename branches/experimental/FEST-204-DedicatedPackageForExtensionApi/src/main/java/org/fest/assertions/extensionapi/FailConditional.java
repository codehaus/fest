...
/**
 * Provides conditional fail methods intended for use by custom assertion classes.
 * 
 * @author Ansgar Konermann
 * 
 */
public class FailConditional extends Fail {

  public static void failIfEqual(String message, Object first, Object second) {
    if (areEqual(first, second)) fail(errorMessageIfEqual(message, first, second));
  }

  public static void failIfNotEqual(String message, Object actual, Object expected) {
  ...
  public static void failIfNull(String message, Object o) {
    if (o == null) fail(concat(format(message), "expecting a non-null object, but it was null"));
  }

  public static void failIfNotNull(String message, Object o) {
    if (o != null) fail(concat(format(message), inBrackets(o), " should be null"));
  }

  public static void failIfSame(String message, Object first, Object second) {
    if (first == second) fail(concat(format(message), "given objects are same:", inBrackets(first)));
  }

  public static void failIfNotSame(String message, Object first, Object second) {
    if (first != second)
      fail(concat(format(message), "expected same instance but found:", inBrackets(first), " and:", inBrackets(second)));
  }

  public static String errorMessageIfNotEqual(String message, Object actual, Object expected) {
    return concat(format(message), errorMessageIfNotEqual(actual, expected));
  }

  public static String errorMessageIfNotEqual(Object actual, Object expected) {
    return concat("expected:", inBrackets(expected), " but was:", inBrackets(actual));
  }

  public static String errorMessageIfEqual(String message, Object actual, Object o) {
    return concat(format(message), errorMessageIfEqual(actual, o));
  }

  public static String errorMessageIfEqual(Object actual, Object o) {
    return comparisonFailed(actual, " should not be equal to:", o);
  }

  public static String errorMessageIfNotGreaterThan(String message, Object actual, Object value) {
    return concat(format(message), errorMessageIfNotGreaterThan(actual, value));
  }

  public static String errorMessageIfNotGreaterThan(Object actual, Object value) {
    return comparisonFailed(actual, " should be greater than:", value);
  }

  public static String errorMessageIfNotGreaterThanOrEqualTo(String message, Object actual, Object value) {
    return concat(format(message), errorMessageIfNotGreaterThanOrEqualTo(actual, value));
  }

  public static String errorMessageIfNotGreaterThanOrEqualTo(Object actual, Object value) {
    return comparisonFailed(actual, " should be greater than or equal to:", value);
  }

  public static String errorMessageIfNotLessThan(String message, Object actual, Object value) {
    return concat(format(message), errorMessageIfNotLessThan(actual, value));
  }

  public static String errorMessageIfNotLessThan(Object actual, Object value) {
    return comparisonFailed(actual, " should be less than:", value);
  }

  public static String errorMessageIfNotLessThanOrEqualTo(String message, Object actual, Object value) {
    return concat(format(message), errorMessageIfNotLessThanOrEqualTo(actual, value));
  }

  public static String errorMessageIfNotLessThanOrEqualTo(Object actual, Object value) {
