 ...
 */
@Test(groups = { GUI, BUG })
public class Bug303_JSpinnerDoesNotSelectExistingTextBeforeEnteringNewText {
  ...
  public void shouldSelectExistingTextBeforeEnteringNewText() {
  ...
  private static class MyWindow extends TestWindow {
    ...
    private MyWindow() {
      super(Bug303_JSpinnerDoesNotSelectExistingTextBeforeEnteringNewText.class);
