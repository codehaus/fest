 ...
 * @author Yvonne Wang
 */
@Test public class ColorFixtureTest {
  ...
  public void shouldPassIfColorsAreEqualAsAnticipated() {
  ...
  public void shouldFailShowingDescriptionIfColorsAreNotEqualAndExpectingEqual() {
  ...
  public void shouldPassIfColorsAreNotEqualAsAnticipated() {
  ...
  public void shouldFailShowingDescriptionIfColorsAreEqualAndExpectingNotEqual() {
    fixture = new ColorFixture(color, "test");
    try {
      fixture.requireNotEqualTo(BLUE);
      failWhenExpectingException();
  ...
  public void shouldPassIfColorIsEqualToHexValue() {
  ...
  public void shouldFailShowingDescriptionIfColorNotEqualToHexValueAndExpectingEqual() {
    fixture = new ColorFixture(color, "test");
    try {
      fixture.requireEqualTo(BLACK_HEX_CODE);
      failWhenExpectingException();
  ...
  public void shouldPassIfColorIsNotEqualToHexValue() {
  ...
  public void shouldFailShowingDescriptionIfColorEqualToHexValueAndExpectingNotEqual() {
    fixture = new ColorFixture(color, "test");
    try {
      fixture.requireNotEqualTo(BLUE_HEX_CODE);
      failWhenExpectingException();
