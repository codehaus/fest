...
/**
 * Tests lookup of <code>{@link JCheckBox}</code>s in <code>{@link ContainerFixture}</code>.
 *
 * @author Alex Ruiz
 */
@Test(groups = GUI)
public class ContainerFixtureJCheckBoxLookupTest {
  ...
  public void shouldFindJCheckBoxByType() {
    JCheckBoxFixture checkBox = fixture.checkBox();
    assertThatFixtureHasCorrectJCheckBox(checkBox);
  }

  public void shouldFailIfJCheckBoxCannotBeFoundByType() {
    execute(new GuiTask() {
      protected void executeInEDT() {
        window.remove(window.checkBox);
      }
    });
    robot.waitForIdle();
    try {
  ...
  public void shouldFindJCheckBoxByName() {
    JCheckBoxFixture checkBox = fixture.checkBox("checkMeBox");
    assertThatFixtureHasCorrectJCheckBox(checkBox);
  }

  public void shouldFailIfJCheckBoxCannotBeFoundByName() {
    try {
  ...
  public void shouldFindJCheckBoxWithCustomMatcher() {
  ...
  private void assertThatFixtureHasCorrectJCheckBox(JCheckBoxFixture checkBoxFixture) {
    assertThat(checkBoxFixture.component()).isSameAs(window.checkBox);
  }

  public void shouldFailIfJCheckBoxCannotBeFoundWithCustomMatcher() {
    try {
  ...
  private static class MyWindow extends TestWindow {
    ...
    private MyWindow() {
      super(ContainerFixtureJCheckBoxLookupTest.class);
