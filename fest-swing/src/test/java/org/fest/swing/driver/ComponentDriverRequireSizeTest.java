 ...
 */
@Test(groups = GUI)
public class ComponentDriverRequireSizeTest extends ComponentDriverTestCase {

  public void shouldPassIfActualSizeIsEqualToExpected() {
    Dimension expected = sizeOf(button());
    driver().requireSize(button(), expected);
  }

  public void shouldFailIfActualSizeIsNotEqualToExpected() {
    try {
