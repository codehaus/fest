 ...
 */
@Test(groups = GUI)
public class ComponentDriverRequireNotVisibleTest extends ComponentDriverTestCase {

  public void shouldPassIfComponentIsNotVisible() {
    hideWindow();
    driver().requireNotVisible(window());
  }

  public void shouldFailIfComponentIsVisible() {
    try {
