...
/**
 * Test case for implementations of <code>{@link FocusOwnerFinderStrategy}</code>.
 *
 * @author Alex Ruiz
 */
@Test(groups = GUI)
public abstract class FocusOwnerFinderStrategyTestCase {
  ...
  public final void shouldFindFocusOwner() {
  ...
  public final void shouldFindFocusInOwnedWindow() {
