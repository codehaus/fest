...
/**
 * Tests for <code>{@link UnexpectedJOptionPaneFinder}</code>.
 *
 * @author Alex Ruiz
 */
@Test public class UnexpectedJOptionPaneFinderTest {
  ...
  public void shouldPassIfThereAreNoJOptionPanesShowing() {
  ...
  public void shouldFailIfThereAreJOptionPanesShowing() {
    new EasyMockTemplate(delegate) {
      protected void expectations() {
