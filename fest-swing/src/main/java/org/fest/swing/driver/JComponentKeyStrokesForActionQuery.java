 ...
 * @author Yvonne Wang
 */
final class JComponentKeyStrokesForActionQuery {

  // TODO: write test case
  static KeyStroke[] keyStrokesForAction(final JComponent component, final String actionName) {
    return execute(new GuiQuery<KeyStroke[]>() {
  ...
  private JComponentKeyStrokesForActionQuery() {}
}