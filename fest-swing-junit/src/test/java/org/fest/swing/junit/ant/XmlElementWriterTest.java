...
/**
 * Tests for <code>{@link XmlElementWriter}</code>.
 *
 * @author Alex Ruiz
 */
@Test public class XmlElementWriterTest {
  ...
  public void shouldPerformWritingAndCallNextIfAvailable() {
    final XmlElementWriter next = createMock(XmlElementWriter.class);
    writer.then(next);
