 ...
 * @author Alex Ruiz
 */
@Test public class FailureScreenshotTakerTest {
  ...
  public void shouldSaveScreenshotWithGivenTestNameAtSpecifiedFolder() {
  ...
  public void shouldNotRethrowExceptionThrownWhenSavingScreenshot() {
    new EasyMockTemplate(screenshotTaker, imageFolder) {
      protected void expectations() throws Exception {
