...
public class BooleanArrayAssert_isNot_Test implements GenericAssert_doesNotSatisfy_TestCase {
  ...
  public void should_throw_error_if_condition_is_null() {
    expectErrorIfConditionIsNull().on(new CodeToTest() {
      public void run() {
        new BooleanArrayAssert(emptyBooleanArray()).isNot(null);
      }
    });
  }
  ...
  public void should_fail_if_condition_is_satisfied() {
    expectAssertionError("actual value:<[]> should not be:<NotNull>").on(new CodeToTest() {
      public void run() {
        new BooleanArrayAssert(emptyBooleanArray()).isNot(notNullBooleanArray());
      }
    });
  }
  ...
  public void should_fail_and_display_description_of_condition_if_condition_is_satisfied() {
    expectAssertionError("actual value:<[]> should not be:<Not Null>").on(new CodeToTest() {
      public void run() {
        new BooleanArrayAssert(emptyBooleanArray()).isNot(notNullBooleanArray().as("Not Null"));
      }
    });
  }
