...
public class DoubleArrayAssert_contains_Test implements GroupAssert_contains_TestCase {
  ...
  public void should_pass_if_actual_contains_given_value() {
    new DoubleArrayAssert(55.03, 4345.91).contains(55.03);
  }
  ...
  public void should_throw_error_if_expected_is_null() {
    expectNullPointerException("the given array of doubles should not be null").on(new CodeToTest() {
      public void run() {
        new DoubleArrayAssert(emptyDoubleArray()).contains(null);
      }
    });
  }
  ...
  public void should_fail_if_actual_does_not_contain_given_values() {
    expectAssertionError("array:<[]> does not contain element(s):<[55.03, 4345.91]>").on(new CodeToTest() {
      public void run() {
        new DoubleArrayAssert(emptyDoubleArray()).contains(55.03, 4345.91);
      }
    });
  }
