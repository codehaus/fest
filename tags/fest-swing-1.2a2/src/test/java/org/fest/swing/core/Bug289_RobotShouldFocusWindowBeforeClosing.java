 ...
 */
@Test(groups = { GUI, BUG })
public class Bug289_RobotShouldFocusWindowBeforeClosing {
  ...
  public void shouldGiveFocusToWindowBeforeClosingIt() {
  ...
  private static class MyWindow extends JFrame {
    ...
    private MyWindow() {
      String title = Bug289_RobotShouldFocusWindowBeforeClosing.class.getSimpleName();
