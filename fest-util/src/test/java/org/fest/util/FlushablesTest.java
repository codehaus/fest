...
/**
 * Tests for <code>{@link Flushables}</code>.
 *
 * @author Yvonne Wang
 */
public class FlushablesTest {
  ...
  private static class FlushableStub implements Flushable {
    ...
    public FlushableStub(IOException toThrow) { this.toThrow = toThrow; }
