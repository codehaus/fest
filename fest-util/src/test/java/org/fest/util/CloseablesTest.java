...
/**
 * Tests for <code>{@link Closeables}</code>.
 *
 * @author Yvonne Wang
 */
public class CloseablesTest {
  ...
  private static class CloseableStub implements Closeable {
    ...
    public CloseableStub(IOException toThrow) { this.toThrow = toThrow; }
  ...
  @Test public void shouldCloseCloseables() {
  ...
  @Test public void shouldIgnoreNullCloseables() {
