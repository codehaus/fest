...
/**
 * Tests for <code>{@link SimpleFallbackExceptionHandler}</code>.
 *
 * @author Alex Ruiz
 */
@Test public class SimpleFallbackExceptionHandlerTest {
  ...
  public void shouldPrintStackTraceOfGivenException() {
